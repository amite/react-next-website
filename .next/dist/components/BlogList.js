...
var BlogList = function (_Component) {
  ...
  (0, _createClass3.default)(BlogList, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement('h2', null, 'Latest Posts'), this.props.posts.map(renderPost), _react2.default.createElement('style', null, '\n          h2 { \n            font-weight: 300;\n            text-align:center;\n            margin: 60px auto;\n            border-bottom: 1px solid #666;\n            max-width: 30%;\n            padding-bottom: 20px;\n          }\n        '));
    }
  }]);
