...
var ContactForm = function (_Component) {
  ...
  function ContactForm(props) {
    ...
    _this.renderTextInput = function (id, label) {
      return _this.renderField(id, label, _react2.default.createElement('input', { type: 'text', className: 'form-control', id: id, ref: id }));
    };

    _this.renderTextarea = function (id, label) {
      return _this.renderField(id, label, _react2.default.createElement('textarea', { className: 'form-control', id: id, ref: id }));
    };

    _this.renderSelect = function (id, label, values) {
      var options = values.map(function (value, index) {
        return _react2.default.createElement('option', { key: index, value: value }, value);
      });
      return _this.renderField(id, label, _react2.default.createElement('select', { className: 'form-control', id: id, ref: id }, options));
    };
    ...
    _this.renderRadioInlines = function (id, label, kwargs) {
      var radios = kwargs.values.map(function (value, index) {
        ...
        return _react2.default.createElement('label', { key: index, className: 'radio-inline' }, _react2.default.createElement('input', { type: 'radio', ref: id + value, name: id, value: value, defaultChecked: defaultChecked }), value);
      });
      return _this.renderField(id, label, radios);
    };

    _this.renderField = function (id, label, field) {
      return _react2.default.createElement('div', { className: $c('form-group', { 'has-error': id in _this.state.errors }) }, _react2.default.createElement('label', { htmlFor: id, className: 'col-sm-4 control-label' }, label), _react2.default.createElement('div', { className: 'col-sm-6' }, field));
    };
